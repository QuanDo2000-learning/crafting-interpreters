...
// Peek at a value distance away from the top of the stack.
...
// Check the value being called if it is callable.
...
// Concatenate 2 string objects from the top of the stack.
static void concatenate() {
  // Only peek instead of pop so they won't get GC.
  ...
  // Pop the 2 original strings off the stack.
  pop();
  pop();
  push(OBJ_VAL(result));
}
...
InterpretResult interpret(const char* source) {
  ...
  // Setup initial CallFrame for the source code.
